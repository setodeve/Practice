...
CREATE TABLE `parts` (
  ...
  `descruption` varchar(255) DEFAULT NULL,
  `price` float DEFAULT NULL,
  `quantityInStock` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_carId` (`carId`),
  CONSTRAINT `fk_carId` FOREIGN KEY (`carId`) REFERENCES `cars` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-02-10  1:36:55
